function [patch_min_edge_scaled,patch_max_edge_scaled] = run_simulation(parameters_obj,input_file_name,destinationFolder,frame_steps,figure_no)
% constants
...
for t = 1:time_steps
    ...
    if mod(t-1,frame_steps)==0
        ...
        %% Saving into file
        set(h1, 'Position', [100   55  850*2.5  650*2.5]);
